...
// Source: src/domain/repositories/field.go
...
// GetFieldsByCollectionId mocks base method.
func (m *MockFieldRepository) GetFieldsByCollectionId(collectionId, projectId int) ([]models.FieldData, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetFieldsByCollectionId", collectionId, projectId)
	ret0, _ := ret[0].([]models.FieldData)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetFieldsByCollectionId indicates an expected call of GetFieldsByCollectionId.
func (mr *MockFieldRepositoryMockRecorder) GetFieldsByCollectionId(collectionId, projectId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetFieldsByCollectionId", reflect.TypeOf((*MockFieldRepository)(nil).GetFieldsByCollectionId), collectionId, projectId)
}
