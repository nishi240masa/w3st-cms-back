...
// Source: domain/repositories/audit.go
...
func (m *MockAuditRepository) FindAll(ctx context.Context) ([]*models.AuditLog, *errors.DomainError) {
	m.ctrl.T.Helper()
...
func (mr *MockAuditRepositoryMockRecorder) FindAll(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindAll", reflect.TypeOf((*MockAuditRepository)(nil).FindAll), ctx)
}
